---
layout: post
title:  The Four Key Elements of Security Systems
...
Below is a table that gives examples of different domains (bank, hospital, army, and home) aligned to the above four elements (Security Engineering — Third Edition): 
